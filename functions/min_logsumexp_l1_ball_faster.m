function u_out = min_logsumexp_l1_ball_faster(v_in,eta, unsorted, N_cum_vec)
%
% Solves the problem
%
...
% sorting.
%
%%%%% -- Updated version, sorting done outside the function -- %%%%%
%%%%%%%%%
% Date of creation (original): 19 October 2023. Filip Elvander
%%%%%%%%
% This version: 11 September 2024. Anton Björkman
%%%%%%%%

% v = sort(v_in,'ascend'); % <-- this is the only change
v = v_in;
N = length(v);
...
u_out = max(unsorted-opt_lagrange_multiplier,0);
end